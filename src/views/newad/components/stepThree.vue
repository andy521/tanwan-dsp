...
<template>
    <div class="newad">
        ...
        <time-week id="timeWeek"></time-week>
        <div class="ad-desc">排期与出价</div>
        <div class="margin-top-20">
            <Form :model="bid" label-position="top">
                <FormItem label="投放日期">
                    <Row :gutter="15">
                        <Col span="7"><DatePicker style="width:100%" v-model="bid.date" type="date" placeholder="长期投放"></DatePicker></Col>
                        <Col span="7"><DatePicker style="width:100%" v-model="bid.date" type="daterange" placement="bottom-end" placeholder="在某日期范围内投放"></DatePicker></Col>
                    </Row>
                </FormItem>
                <FormItem label="投放时间">
...
export default {
    ...
    methods:{
        selectMun(val){
            let ss = document.getElementById("timeWeek").offsetTop;
            //window.scrollTo( 0, ss - 20 )
            console.log(val)
