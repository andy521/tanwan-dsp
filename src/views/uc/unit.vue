    ...
    <div class="unit">
        ...
        <Modal v-model="bidModal" title="修改出价" @on-ok="setBid" @on-cancel=" bidModal = false ">
            ...
            <div class="margin-top-10">
                <Input-number style="width:200px;" :max="percentageMax" :min="1" v-model="percentage"></Input-number> %</div>
        </Modal>
...
export default {
    ...
    methods: {
        ...
        getTableColumns() {
            ...
            data.push(
                tableColumnList.adgroup_id,
                tableColumnList.author,
                tableColumnList.operate
            );
            return data;
        },
        changeTableColumns() {
