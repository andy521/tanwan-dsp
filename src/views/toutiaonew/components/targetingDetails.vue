        ...
        <div class="newtt">
            ...
            <Form :label-width="80" class="margin-top-20" onsubmit="return false;" label-position="left">
                ...
                <FormItem label="手机品牌" v-if="isInArray(targeting.platform,'ANDROID')||targeting.platform.length==0">
                    ...
                    <div class="margin-top-10">
                        <device-tree v-model="targeting.device_brand" :title="'手机品牌'" :datas="device_brand" v-if="device_brand_model=='1'"></device-tree>
                    </div>
                </FormItem>
                ...
                <FormItem label="受众最低android版本" v-if="apptype=='APP_ANDROID'&&pricing=='PRICING_OCPM'">
                    <Row>
                        ...
                        <RadioGroup v-model="targeting.android_osv" size="large" type="button" vertical>
                            <Radio v-for="item in toutiaoConfig.android_osv" :label="item.val_type" :key="this">{{item.name}}</Radio>
                        </RadioGroup>
                        </Col>
                    </Row>
                </FormItem>
                ...
                <FormItem label="受众最低ios版本" v-if="apptype=='APP_IOS'&&pricing=='PRICING_OCPM'">
                    <Row>
                        ...
                        <RadioGroup v-model="targeting.ios_osv" size="large" type="button" vertical>
                            <Radio v-for="item in toutiaoConfig.ios_osv" :label="item.val_type" :key="this">{{item.name}}</Radio>
                        </RadioGroup>
                        </Col>
                    </Row>
                </FormItem>
                ...
                <FormItem v-if="advanced_options">
                    ...
                    <div class="margin-top-10">
                        <device-tree v-model="targeting.article_category" :title="'文章分类'" :datas="article_category" v-if="article_category_model=='1'"></device-tree>
                    </div>
                </FormItem>
            ...
            <div class="city_main">
                ...
                <div class="city_box">
                    <div class="padding-10 ">
                        ...
                        <div class="targeting_item" v-if="targeting.gender&&targeting.gender!='GENDER_UNLIMITED'">
                            <span>性别：</span>
                            <span class="grey">
...
export default {
    ...
    data() {
        return {
            ...
            targeting: {
                ...
                device_brand: [],//受众手机品牌
                article_category: [],//受众文章分类
                android_osv: "0.0",//受众最低android版本(
                ios_osv: "0.0"//受众最低ios版本
            },
            age_model: "0",
            ad_tag_model: "0",
    ...
    methods: {
        ...
        changetargeting(targeting) {
            ...
            if (targeting.targeting.android_osv) {
                this.targeting.android_osv = targeting.targeting.android_osv; // 受众最低android版本
            } else {
                this.targeting.android_osv = '0.0';
            }

            if (targeting.targeting.ios_osv) {
                this.targeting.ios_osv = targeting.targeting.ios_osv; // 受众最低ios版本
            } else {
                this.targeting.ios_osv = '0.0';
            }
