...
<template>
  <div class="creativecategory">
    <Input @click.native="handleShowPanel" v-model="currcategoryName" readonly :autofocus="false" type="text">
    <div @click="handleShowPanel" slot="append" style="width: 70px;cursor:pointer">
      <div v-show="!isShow"><Icon type="arrow-down-b"></Icon>展开</div>
      <div v-show="isShow"><Icon type="arrow-up-b"></Icon>收起</div>
    </div>
    </Input>
