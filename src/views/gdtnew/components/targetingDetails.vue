...
.ds_item_on {
  ...
  box-shadow: 0 0 3px rgba(57, 73, 103, 0.05) inset;
}
            ...
            <Row class="margin-top-20">
                ...
                <div class="ds_items margin-top-20">
                    <div class="ds_item" :class="{ ds_item_on: city_modeal }">
                        <div :class="{ verify: !verify_geo_location }">
                            <div class="ds_tit">
                                <span class="ds_item_hd">地域
                                    <em class="red" v-if="!verify_geo_location">请选择地区及地点类型</em>
                                </span>
                    ...
                    <div class="ds_item" :class="{ ds_item_on: age_modeal }">
                        <div class="ds_tit">
                    ...
                    <div class="ds_item" :class="{ ds_item_on: gender_modeal }">
                        <div class="ds_tit">
                    ...
                    <div class="ds_item" :class="{ ds_item_on: business_modeal }">
                        <div :class="{ verify: !verify_business_interest }">
                            <div class="ds_tit">
                                <span class="ds_item_hd">商业兴趣
                                    <em class="red" v-if="!verify_business_interest">请选择商业兴趣</em>
                                </span>
                    ...
                    <div class="ds_item" :class="{ ds_item_on: appCategory_modeal }">
                        <div :class="{ verify: !verify_app_behavior }">
                            <div class="ds_tit">
                                <span class="ds_item_hd">App行为
                                    <em class="grey">特定类型App的活跃或付费用户</em>
                                    <em class="red" v-if="!verify_app_behavior">请正确设置APP分类(最多10个)、用户类型、距今天数(1~365)
                                    </em>
                                </span>
                    ...
                    <div class="ds_item" :class="{ ds_item_on: app_install_status_modeal }">
                        <div :class="{ verify: !verify_app_install_status }">
                            <div class="ds_tit">
                                <span class="ds_item_hd">App安装
                                    <em class="grey">已安装或未安装所推广App的用户</em>
                                </span>
                    ...
                    <div class="ds_item" :class="{ ds_item_on: network_modeal }">
                        <div :class="{ verify: !verify_network_type }">
                            <div class="ds_tit">
                    ...
                    <div class="ds_item" :class="{ ds_item_on: Audiences_modeal }">
                        <div :class="{ verify: !verify_Audiences }">
                            <div class="ds_tit">
                                <span class="ds_item_hd">自定义人群
                                    <em class="grey">选择特定人群用于投放</em>
                                </span>
                    ...
                    <div class="ds_item" :class="{ ds_item_on: paying_user_type_modeal }">
                        <div :class="{ verify: !verify_paying_user_type }">
                            <div class="ds_tit">
                                <span class="ds_item_hd">付费用户
                                    <em class="grey">有网上付费行为的用户</em>
                                </span>
                ...
                <Modal v-model="winshow" title="全部定向" width="900">
                    <div class="ds_items">
                        ...
                        <div class="ds_item" :class="{ ds_item_on: education_modeal }">
                            <div :class="{ verify: !verify_education }">
                                <div class="ds_tit">
                        ...
                        <div class="ds_item" :class="{ ds_item_on: living_status_modeal }">
                            <div :class="{ verify: !verify_living_status }">
                                <div class="ds_tit">
                        ...
                        <div class="ds_item" :class="{ ds_item_on: word_modeal }">
                            <div :class="{ verify: !verify_words }">
                                <div class="ds_tit">
                                    <span class="ds_item_hd">关键词
                                        <em class="grey">对指定关键词感兴趣的用户</em>
                                        <em class="red" v-if="!verify_words">请输入关键字,最大长度 500,字段长度最大 30 字节</em>
                                    </span>
                        ...
                        <div class="ds_item" :class="{ ds_item_on: shopping_capability_modeal }">
                            <div :class="{ verify: !verify_shopping_capability }">
                                <div class="ds_tit">
                        ...
                        <div class="ds_item " :class="{ ds_item_on: network_operator_modeal }">
                            <div :class="{ verify: !verify_network_operator }">
                                <div class="ds_tit">
                        ...
                        <div class="ds_item" :class="{ ds_item_on: device_price_modeal }">
                            <div :class="{ verify: !verify_device_price }">
                                <div class="ds_tit">
    ...
    computed: {
        ...
        verify_geo_location() {
            ...
            if (!this.city_modeal) {
                ...
                geo_location.regions.length <= 0 ||
                geo_location.location_types.length <= 0
            ) {
                return false;
            } else {
                return true;
        ...
        verify_app_behavior() {
            ...
            if (!this.appCategory_modeal) {
                ...
                app_behavior.time_window == "" ||
                app_behavior.act_id_list.length <= 0 ||
                app_behavior.object_id_list.length <= 0 ||
                app_behavior.object_id_list.length > 10
            ) {
                return false;
            } else {
                return true;
        ...
        verify_Audiences() {
            ...
            if (!this.Audiences_modeal) {
                ...
                customized_audience.length <= 0 &&
                excluded_custom_audience.length <= 0
            ) {
                return false;
            } else {
                return true;
