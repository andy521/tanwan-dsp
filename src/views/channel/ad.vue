    ...
    <Card dis-hover shadow>
        <div class="head">
            <Row :gutter="10">
                <Col :xs="12" :md="4">
                    <!-- 媒体选择: -->
                    <Select @on-change="setAd" placeholder="--广告选择--" style="width:100%"  class="margin-bottom-10">
    ...
    methods : {
        ...
        getTableColumns(){
            const tableColumnList = {
                ...
                media_name : {title: '媒体账号', key: 'media_name', sortable: true,"width": 150 },                               
